...
if __name__ == '__main__':
    ...
    model = UNO_reparam(in_channels = 2, out_channels = 1, hidden_channels = 64, n_samples = 10, uno_out_channels=[32,64,64,32],
                uno_n_modes=[[5,5],[5,5],[5,5],[5,5]], uno_scalings=[[1.0,1.0],[0.5,0.5],[1,1],[2,2]], n_layers = 4)
